...
public class MinePresenter extends BasePresenter<MineView> {
    ...
    public void initMap(){
        mLocationClient = new LocationClient(NewsApplication.getContext());     //声明LocationClient类
            ...
            ServiceFactory.getInstance().createService(WeatherService.class)
                    ...
                    .subscribe(new Subscriber<WeatherBean>() {
                        ...
                        public void onNext(WeatherBean weatherBean) {
                            ...
                            mvpView.showWeather(weatherBean.getResult().get(0),addre);
                        }
                    });
        } catch (Exception e) {
            e.printStackTrace();
    ...
    class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (location.getLocType() == BDLocation.TypeGpsLocation) {// GPS定位结果
                ...
                sb.append("\ndescribe : "+location.getCity()+location.getDistrict());
                sb.append("网络定位成功");
            ...
            getWeather("北京",location.getDistrict(),location.getAddrStr());
        }
