...
/** 
 * DAO for table "CHANNEL_SELECTED".
*/
public class ChannelSelectedDao extends AbstractDao<ChannelSelected, Long> {

    public static final String TABLENAME = "CHANNEL_SELECTED";

    /**
     * Properties of entity ChannelSelected.<br/>
    ...
    public ChannelSelectedDao(DaoConfig config) {
        super(config);
    }
    
    public ChannelSelectedDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHANNEL_SELECTED\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CHANNEL_SELECTED\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ChannelSelected entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ChannelSelected entity) {
        stmt.clearBindings();
    ...
    @Override
    public ChannelSelected readEntity(Cursor cursor, int offset) {
        ChannelSelected entity = new ChannelSelected( //
    ...
    @Override
    public void readEntity(Cursor cursor, ChannelSelected entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ChannelSelected entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ChannelSelected entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ChannelSelected entity) {
