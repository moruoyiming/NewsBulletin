...
/** 
 * DAO for table "CHANNELUN_SELECTED".
*/
public class ChannelunSelectedDao extends AbstractDao<ChannelunSelected, Long> {

    public static final String TABLENAME = "CHANNELUN_SELECTED";

    /**
     * Properties of entity ChannelunSelected.<br/>
    ...
    public ChannelunSelectedDao(DaoConfig config) {
        super(config);
    }
    
    public ChannelunSelectedDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHANNELUN_SELECTED\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CHANNELUN_SELECTED\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ChannelunSelected entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ChannelunSelected entity) {
        stmt.clearBindings();
    ...
    @Override
    public ChannelunSelected readEntity(Cursor cursor, int offset) {
        ChannelunSelected entity = new ChannelunSelected( //
    ...
    @Override
    public void readEntity(Cursor cursor, ChannelunSelected entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ChannelunSelected entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ChannelunSelected entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ChannelunSelected entity) {
