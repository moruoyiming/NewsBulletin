...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        com.mrym.newsbulletion.db.entity.NewsChannelTableDBDao.createTable(db, ifNotExists);
        VideoChannelTableDBDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        com.mrym.newsbulletion.db.entity.NewsChannelTableDBDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(NewsChannelTableDBDao.class);
