...
/*
   1. noCache 不使用缓存，全部走网络
    ...
    private Api(int hostType) {
        ...
        //缓存
        File cacheFile = new File(NewsApplication.getContext().getCacheDir(), "cache");
        ...
        retrofit = new Retrofit.Builder()
                ...
                .baseUrl(GlobalVariable.getHost(hostType))
                .build();
        movieService = retrofit.create(ApiStores.class);
    }
     ...
     */
    public static ApiStores getDefault(int hostType) {
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetConnected(NewsApplication.getContext()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
    ...
    private final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetWorkUtils.isNetConnected(NewsApplication.getContext())) {
